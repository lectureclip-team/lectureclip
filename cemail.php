                ...
                <form action="" method="post">
                    <div class="tblA">
                        <dl>
                                ...
                                if (isset($_POST['submit_cemail'])) {
                                    ...
                                    if (password_verify($password_form, $pwd)) {
                                        if ($new_email_form != $cnewemail_form && empty($new_email_form) && empty($cnewemail_form)) {
                                            ...
                                            $_SESSION['myUser'] = $new_email_form;
                                            
                                            // $newcookie = $obj->singleData($new_email_form, "email", "tbl_ut_pass");
                                            // setcookie("lc_login_id", $newcookie['email']);
                            ...
                            <dd>
                                <p class="btn btn_red">
                                    <input type="submit" name="submit_cemail" value="メールアドレスの変更">
                                </p>
                            </dd>
                        </dl>
                    </div>
